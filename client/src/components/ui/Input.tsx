...
export default function Input({
  ...
  const baseStyles =
    "w-full px-4 py-2.5 border-2 rounded-lg text-neutral-100 placeholder-neutral-500 bg-neutral-800/50 backdrop-blur-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 focus:bg-neutral-800";
